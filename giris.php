                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="" method="post">
                            <h3 class="text-center text-info">GİRİŞ</h3>
                            ...
                            <div class="form-group">
                                ...
                                <input type="button"  onClick="location.href='musteriarayuz.php'" name="submit" class="btn btn-danger btn-md" value="İptal">                     
                               
                                <input type="button" name="submit" onClick="location.href='musterigirisarayuz.php'" class="btn btn-success btn-md" value="Giriş">
                                <input type="button" onClick="location.href='kayitol.php'" name="submit" class="btn btn-info btn-md" value="Kayıt Ol">

                            </div>
                            <div id="register-link" class="text-right">
                                <a href="sifremiunuttum.php" class="text-info">Şifremi Unuttum</a>
                            </div>
                        </form>
                    </div>
                </div>
