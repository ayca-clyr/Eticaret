...
<div id="login">
        ...
        <div class="container">
        <div class="mx-auto text-danger font-weight-bold" >
                            <h3 class="text-center text-info">Üyelik Sayfamıza Hoşgeldiniz.</h3>
                            <br>
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="slogin-form" class="form" action="" method="post">
                            <div class="form-group">
                                <label for="username" class="text-info">Adı Soyadı:</label><br>
                                <input type="text" name="username" id="username" class="form-control">
                            </div>

                            <div class="form-group">
                                <label for="birtday" class="text-info">Doğum Tarihi:</label><br>
                                <input type="number" name="birtday" id="birtday" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="phone" class="text-info">Telefon:</label><br>
                            ...
                            <div class="form-group">
                                <label for="password2" class="text-info">*Tekrar Şifre</label><br>
                                <input type="text" name="password2" id="password2" class="form-control">
                            </div>
                            <div class="form-group">
                         
                                <input type="button"onClick="location.href='giris.php'" name="submit" class="btn btn-danger btn-md" value="İptal">
